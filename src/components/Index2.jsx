...
export default function Index2({ data }) {
    return (
        ...
        <div className="menu-layer">
                        ...
                        <div className="col-lg-2 col-md-6 col-sm-6">
                            <div className="data-time-two">
                                <div className="count-time two">
                                    <h2 className="timer count-title count-number" data-to={12} data-speed={2000}>12</h2><span>+</span>
                                </div>
                                <h6>Years Working
                                    Experience</h6>
                            </div>
                            <div className="data-time-two boder">
                                <div className="count-time two">
                                    <h2 className="timer count-title count-number" data-to={10} data-speed={2000}>10</h2><span>k</span>
                                </div>
                                <h6>Happy Satisfied
                                    Customers</h6>
                            </div>
            ...
            <section className="services two gap">
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                            <div className="service-data one">
                                ...
                                <h5><a className="magic-hover magic-hover__square" href="services-details.html">Graphichs Design</a></h5>
                                <p>Lorem ipm dolor amet, cons
                                    magm maiores Ipsa dolor sit
                                    magnam maores.</p>
                            </div>
                        </div>
                        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay={300} data-aos-duration={400}>
                            <div className="service-data two">
                                <div className="svg-img">
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay={400} data-aos-duration={500}>
                            <div className="service-data three">
                                <div className="svg-img">
                                ...
                                <h5><a className="magic-hover magic-hover__square" href="services-details.html">Stunning Design</a></h5>
                                <p>Lorem ipm dolor amet, cons
                                    magm maiores Ipsa dolor sit
                                    magnam maores.</p>
                            </div>
                        </div>
                        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay={500} data-aos-duration={600}>
                            <div className="service-data for">
                                <div className="svg-img">
                                ...
                                <h5><a className="magic-hover magic-hover__square" href="services-details.html">Project Management</a></h5>
                                <p>Lorem ipm dolor amet, cons
                                    magm maiores Ipsa dolor sit
                                    magnam maores.</p>
                            </div>
            ...
            <section className="my-project hom3 two gap no-top">
                <div className="container">
                    <div className="hading" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                        <img alt="dots" src="img/dots.png" />
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                            <div className="portfolio-detail">
                                <div className="portfolio-img hover06">
                                    <figure>
                                        <img alt="profile img" src="https://via.placeholder.com/586x387" />
                                    </figure>
                                    <a className="magic-hover magic-hover__square" href="portfolio-details-1.html">Doerner Investigations</a>
                                    <p>Website Design, Branding</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay={300} data-aos-duration={400}>
                            <div className="portfolio-detail">
                                <div className="portfolio-img hover06">
                                    <figure>
                                        <img alt="profile img" src="https://via.placeholder.com/586x387" />
                        ...
                        <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay={500} data-aos-duration={600}>
                            <div className="portfolio-detail">
                                <div className="portfolio-img hover06">
                                    <figure>
                                        <img alt="profile img" src="https://via.placeholder.com/366x261" />
                                    </figure>
                                    <a className="magic-hover magic-hover__square" href="portfolio-details-1.html">Web Mockup</a>
                                    <p>Studio, Branding</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay={600} data-aos-duration={700}>
                            <div className="portfolio-detail">
                                <div className="portfolio-img hover06">
                                    <figure>
                                        <img alt="profile img" src="https://via.placeholder.com/366x261" />
                                    </figure>
                                    <a className="magic-hover magic-hover__square" href="portfolio-details-1.html">Illustrator Design</a>
                                    <p>Website Design, Branding</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                            <div className="portfolio-detail">
                                <div className="portfolio-img hover06">
                                    <figure>
                                        <img alt="profile img" src="https://via.placeholder.com/366x261" />
                                    </figure>
                                    <a className="magic-hover magic-hover__square" href="portfolio-details-1.html">Vector Art</a>
                                    <p>Website Design, Branding</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay={300} data-aos-duration={400}>
                            <div className="portfolio-detail">
                                <div className="portfolio-img hover06">
                                    ...
                                    <a className="magic-hover magic-hover__square" href="portfolio-details-1.html">Branding Identity</a>
                                    <p>Website Design, Branding</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay={400} data-aos-duration={500}>
                            <div className="portfolio-detail">
                                <div className="portfolio-img hover06">
                                    <figure>
                                        <img alt="profile img" src="https://via.placeholder.com/586x387" />
                                    </figure>
                                    <a className="magic-hover magic-hover__square" href="portfolio-details-1.html">App UX UI Design</a>
                                    <p>Website Design, Branding</p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="work-experience-two gap" style={{ backgroundImage: 'url(./img/blur-1.png)' }}>
                <div className="container">
                    <div className="hading" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                        <p>Professional Experience</p>
                        <h2>Work Experience</h2>
                    </div>
                    <div className="row present-data-home-page owl-carousel owl-theme" data-aos="fade-up" data-aos-delay={300} data-aos-duration={400}>
                        <div className="col-lg-12 item">
                            <div className="to-present">
                                <span>2018 to Present</span>
                                <h6>Graphic Designer</h6>
                                <div className="envato-studio">
                                    <h4>Envato Studio</h4>
            ...
            <section className="gap no-bottom" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                <div className="container">
                    <div className="hading">
                        <p>News &amp; Blog</p>
                        <h2>Recent Articles</h2>
                    </div>
                    <div className="zoom-slider owl-carousel">
                        <div className="item zoom-slider-img">
                            <img src="https://via.placeholder.com/649x395" alt="img" />
                            <div className="zoom-slider-data">
                                &lt;<span>December 5, 2023</span><div className="dodgap" /><span>  John Smith</span>
                                <h5><a className="magic-hover magic-hover__square" href="blog-details-2.html">Interview Photographer Mark
                                    Seliger Agency</a></h5>
                            </div>
                        </div>
                        <div className="item zoom-slider-img">
                    ...
                    <div className="row">
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                            <div className="hading">
                                <p>Work Packages</p>
                                <h2>Pricing Plans</h2>
                                <h6>Lorem ipm dolor amet, cons magm maiores Ipsa
                                    dolor sitmagnam maores. Lorem ipm dolor amet,
                                    cons magm maiores Ipsa dolor sitma.</h6>
                            </div>
                        </div>
