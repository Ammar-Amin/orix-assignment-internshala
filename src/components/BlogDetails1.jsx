...
export default function BlogDetails1({ data }) {
  return (
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8 col-md-12 col-sm-12">
              <div className="blog-details-one-data">
                <div
                  className="img-data"
                  data-aos="fade-up"
                  data-aos-delay={200}
                ...
                <div className="row">
                  ...
                  >
                    <div className="img-large hover06">
                      <figure>
                        <img
                          alt="blog-2"
                          src="https://via.placeholder.com/563x380"
                        />
                      </figure>
                    </div>
                  </div>
                  ...
                  >
                    <div className="img-large hover06">
                      <figure>
                        <img
                          alt="blog-2"
                          src="https://via.placeholder.com/249x380"
                        />
                      </figure>
                    </div>
                  </div>
                  ...
                  >
                    <div className="img-large hover06">
                      <img
                        alt="blog-img"
                        src="https://via.placeholder.com/856x380"
                      />
                      <a
                        data-fancybox=""
                ...
                <div className="row align-items-center blog-gap">
                  ...
                  >
                    <img
                      className="two"
                      alt="blog-img"
                      src="https://via.placeholder.com/249x197"
                    />
                  </div>
                </div>
                <p>
            ...
            <div className="col-lg-4 col-md-12 col-sm-12">
              ...
              >
                ...
                <li className="recent-news-data">
                  ...
                  <div className="recent-data">
                    <h6>December 5, 2023</h6>
                    <a className="magic-hover magic-hover__square" href="#">
                      Interview Photographer Mark Seliger
                    </a>
                  </div>
                </li>
                <li className="recent-news-data">
              ...
              <ul
                className="recent-news categories"
                data-aos="fade-up"
                data-aos-delay={200}
                data-aos-duration={300}
              >
                ...
                <li>
                  <a className="magic-hover magic-hover__square" href="#">
                    Ui/Ux Design<span>10</span>
                  </a>
                </li>
                <li>
                  <a className="magic-hover magic-hover__square" href="#">
                    Creative Studio<span>10</span>
                  </a>
                </li>
                <li>
                  <a className="magic-hover magic-hover__square" href="#">
                    Mobile Application<span>10</span>
                  </a>
                </li>
              </ul>
              <ul
                className="recent-news meta-links"
                data-aos="fade-up"
                data-aos-delay={200}
                data-aos-duration={300}
              >
                ...
                <li>
                  <div>
                    ...
                    <a className="magic-hover magic-hover__square" href="#">
                      <i className="fa-solid fa-caret-right" /> Entries RSS
                    </a>
                    <a className="magic-hover magic-hover__square" href="#">
                      <i className="fa-solid fa-caret-right" /> Comments RSS
                    </a>
                    <a className="magic-hover magic-hover__square" href="#">
                      <i className="fa-solid fa-caret-right" /> WordPress.org
                    </a>
                  </div>
                </li>
              </ul>
              <ul
                className="recent-news gallery-photos"
                data-aos="fade-up"
                data-aos-delay={200}
                data-aos-duration={300}
              >
                ...
                <li>
                  <a
                    className="magic-hover magic-hover__square"
                    href="https://via.placeholder.com/150x150"
                    data-fancybox="gallery"
                  >
                    <img alt="girl" src="https://via.placeholder.com/150x150" />
                  </a>
              ...
              <div
                className="recent-news subscribe"
                data-aos="fade-up"
                data-aos-delay={200}
                data-aos-duration={300}
              >
                ...
                <form className="blog">
                  ...
                  />
                  <button className="magic-hover magic-hover__square button load button--moema button--text-thick button--text-upper button--size-s">
                    subscribe
                  </button>
                </form>
              </div>
