                        ...
                        <div className="col-lg-5" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                            <div className="hello-im">
                                ...
                                <ul className="social-media-footer head">
                                    ...
                                    <li><a className="magic-hover magic-hover__square" href="#"><i className="fa-brands fa-vimeo-v vi" /></a></li>
                                </ul>
                            </div>
                        </div>
            ...
            <section className="about gap">
                <div className="container">
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6" data-aos="fade-up" data-aos-delay={300} data-aos-duration={400}>
                            <div className="home-one-progress home-3-pro">
                                <div className="count-time">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6" data-aos="fade-up" data-aos-delay={400} data-aos-duration={500}>
                            <div className="home-one-progress home-3-pro">
                                <div className="count-time">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6" data-aos="fade-up" data-aos-delay={500} data-aos-duration={600}>
                            <div className="home-one-progress home-3-pro">
                                <div className="count-time">
                ...
                <div className="container">
                    ...
                    <div className="portfolios">
                        <div className="filters portfolio-controllers-container">
                            <div className=" portfolio-controllers wow fadeLeft button-group js-radio-button-group" data-wow-duration="1s" data-wow-delay=".1s" data-aos="fade-up" data-aos-delay={300} data-aos-duration={400} data-filter-group="color">
                        ...
                        <div className="grid row align-items-center" data-aos="fade-up" data-aos-delay={400} data-aos-duration={500}>
                            ...
                            <div className="col-lg-4 Design Development">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img hover06">
                                        <figure>
                                            <img alt="profile img" src="https://via.placeholder.com/366x271" />
                                        </figure>
                                        <a className="magic-hover magic-hover__square" href="#">Creative Studio</a>
                                        <p>Website Design &amp; Development</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 Branding">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img hover06">
                                        <figure>
                                            <img alt="profile img" src="https://via.placeholder.com/366x271" />
                                        </figure>
                                        <a className="magic-hover magic-hover__square" href="#">Mice Goofballs.</a>
                                        <p>Branding</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4  Branding Development UI-Design">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img hover06">
                                        <figure>
                                            <img alt="profile img" src="https://via.placeholder.com/366x271" />
                                        </figure>
                                        <a className="magic-hover magic-hover__square" href="#">Mobile Development</a>
                                        <p>Digital Web</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 Design UI-Design ">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img hover06">
                                        <figure>
                                            <img alt="profile img" src="https://via.placeholder.com/366x271" />
                                        </figure>
                                        <a className="magic-hover magic-hover__square" href="#">Grid Mockup</a>
                                        <p>Motion</p>
                                    </div>
                                </div>
                            </div>
