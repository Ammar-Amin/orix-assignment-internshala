        ...
        <div className="menu-layer">
                        ...
                        <div className="col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                            <div className="about-mee">
                                ...
                                <ul className="social-media-icon"><li><a href="pdf/orix.pdf" className="magic-hover magic-hover__square button button--moema button--text-thick button--text-upper button--size-s"><i className="fa-solid fa-download" target="_blank" />Download CV</a></li>
                                    <li><a className="f magic-hover magic-hover__square" href=""><i className="fa-brands fa-facebook-f" /></a></li>
                    ...
                    <div className="row">
                            ...
                            <div className="service-data">
                                <div className="svg-img">
                                    <svg id="Layer_1" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 43.81 		42.15">
                                        {
                                            // <img src={data.services[0].image.url} />
                                        }
                                        {
                                ...
                                <h5><a className="magic-hover magic-hover__square" href="services-details.html">{data.services[0].name}</a></h5>
                                <p>Cost : {data.services[0].charge}</p>
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay={300} data-aos-duration={400}>
                            <div className="service-data">
                                ...
                                <h5><a className="magic-hover magic-hover__square" href="services-details.html">{data.services[1].name}</a></h5>
                                <p>Cost : {data.services[1].charge}</p>
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay={400} data-aos-duration={500}>
                            <div className="service-data">
                                ...
                                <h5><a className="magic-hover magic-hover__square" href="services-details.html">{data.services[2].name}</a></h5>
                                <p>Cost : {data.services[2].charge}</p>
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                            <div className="service-data">
                                ...
                                <h5><a className="magic-hover magic-hover__square" href="services-details.html">{data.services[3].name}</a></h5>
                                <p>Cost : {data.services[3].charge}</p>
                                <p>{data.services[3].desc}</p>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay={300} data-aos-duration={400}>
                            <div className="service-data">
                                ...
                                <h5><a className="magic-hover magic-hover__square" href="services-details.html">{data.services[4].name}</a></h5>
                                <p>Cost : {data.services[4].charge}</p>
                                <p>{data.services[4].desc}</p>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay={400} data-aos-duration={500}>
                            <div className="service-data">
                                ...
                                <h5><a className="magic-hover magic-hover__square" href="services-details.html">{data.services[5].name}</a></h5>
                                <p>Cost : {data.services[5].charge}</p>
                                <p>{data.services[5].desc}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                            <div className="resume-data">
                                ...
                                <div className="education">
                                    <h5>2012 to 2014</h5>
                                    <p>{data.timeline[5].jobTitle}</p>
                                    <div className="studies">
                                        <h6>{data.timeline[5].company_name}</h6>
                                        <p>{data.timeline[5].bulletPoints}</p>
                                    </div>
                                </div>
                                <div className="education">
                                    <h5>2010 to 2012</h5>
                                    <p>{data.timeline[3].jobTitle}</p>
                                    <div className="studies">
                                        <h6>{data.timeline[3].company_name}</h6>
                                        <p>{data.timeline[3].summary}</p>
                                    </div>
                                </div>
                                <div className="education end">
                                    <h5>2008 to 2010</h5>
                                    <p>{data.timeline[0].jobTitle}</p>
                                    <div className="studies">
                                        <h6>{data.timeline[0].company_name}</h6>
                                        <p>{data.timeline[0].summary}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                            <div className="resume-data">
                                ...
                                <div className="education">
                                    ...
                                    <p>{data.timeline[4].jobTitle}</p>
                                    <div className="studies">
                                        <h6>{data.timeline[4].company_name}</h6>
                                        <p>{data.timeline[4].bulletPoints[1]}</p>
                                    </div>
                                </div>
                                <div className="education">
                                    <h5>2016 to 2018</h5>
                                    <p>{data.timeline[2].jobTitle}</p>
                                    <div className="studies">
                                        <h6>{data.timeline[2].company_name}</h6>
                                        <p>{data.timeline[2].summary}</p>
                                    </div>
                                </div>
                                <div className="education end">
                                    <h5>20014 to 2016</h5>
                                    <p>{data.timeline[1].jobTitle}</p>
                                    <div className="studies">
                                        <h6>{data.timeline[1].company_name}</h6>
                                        <p>{data.timeline[1].summary}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="my-project gap">
                <div className="container">
                    ...
                    <div className="portfolios">
                        ...
                        <div className="grid row align-items-center" data-aos="fade-up" data-aos-delay={400} data-aos-duration={500}>
                            <div className="col-lg-4  UI-Design Branding">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img">
                                        <figure className="gap-img">
                                            <img className="one hove" alt="profile img" src={data.projects[0].image.url} style={{ width: '250px', height: '250px', objectFit: 'contain' }} />
                            ...
                            <div className="col-lg-4 UX/UI-Design Branding">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img">
                                        <figure className="gap-top">
                                            <img alt="profile img" src={data.projects[1].image.url} style={{ width: '366px', height: '366px', objectFit: 'contain' }} />
                                            <div className="hover-data">
                                                <a className="magic-hover magic-hover__square" href="#">App UX UI Design</a>
                            ...
                            <div className="col-lg-4 Design Development">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img">
                                        <figure className="gap-img">
                                            <img className="one" alt="profile img" src={data.projects[2].image.url} style={{ width: '250px', height: '250px', objectFit: 'contain' }} />
                                            <div className="hover-data">
                                                <a className="magic-hover magic-hover__square" href="#">List of Brands</a>
                                                <p>Digital Web</p>
                                            </div>
                            ...
                            <div className="col-lg-4 Branding Design">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img">
                                        <figure className="gap-top">
                                            <img alt="profile img" src={data.projects[3].image.url} style={{ width: '366px', height: '300px', objectFit: 'contain' }} />
                                            <div className="hover-data">
                                                <a className="magic-hover magic-hover__square" href="#">List of Brands</a>
                                                <p>Digital Web</p>
                                            </div>
                            ...
                            <div className="col-lg-4 Design Development">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img">
                                        <figure className="gap-img">
                                            <img className="one" alt="profile img" src={data.projects[5].image.url} style={{ width: '250px', height: '250px', objectFit: 'contain' }} />
                                            <div className="hover-data">
                                                <a className="magic-hover magic-hover__square" href="#">List of Brands</a>
                                                <p>Digital Web</p>
                                            </div>
                            ...
                            <div className="col-lg-4 Branding  UI-Design Design">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img">
                                        <figure className="gap-top">
                                            <img alt="profile img" src={data.projects[4].image.url} style={{ width: '366px', height: '366px', objectFit: 'contain' }} />
                                            <div className="hover-data">
                                                <a className="magic-hover magic-hover__square" href="#">Presentation Mockup</a>
                                                <p>Website Design &amp; Development</p>
                                            </div>
                                        </figure>
                                    </div>
                            ...
                            <div className="col-lg-4 UX/UI UI-Design Design">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img">
                                        <figure className="gap-img">
                                            <img className="one" alt="profile img" src={data.projects[6].image.url} style={{ width: '250px', height: '250px', objectFit: 'contain' }} />
                                            <div className="hover-data">
                                                <a className="magic-hover magic-hover__square" href="#">List of Brands</a>
                                                <p>Digital Web</p>
                                            </div>
                            ...
                            <div className="col-lg-4 Design Development Branding Design">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img">
                                        <figure className="gap-top">
                                            <img alt="profile img" src={data.projects[7].image.url} style={{ width: '366px', height: '366px', objectFit: 'contain' }} />
                                            <div className="hover-data">
                                                <a className="magic-hover magic-hover__square" href="#">Website Design</a>
                                                <p>Website Design &amp; Development</p>
                                            </div>
                                        </figure>
                                    </div>
                            ...
                            <div className="col-lg-4 UI-Design Design">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img">
                                        <figure className="gap-img">
                                            <img className="one" alt="profile img" src={data.projects[8].image.url} style={{ width: '250px', height: '250px', objectFit: 'contain' }} />
                                            <div className="hover-data">
                                                <a className="magic-hover magic-hover__square" href="#">List of Brands</a>
                                                <p>Digital Web</p>
                                            </div>
                    ...
                    <div className="load-button">
                        <a href="#" className="magic-hover magic-hover__square button button--moema button--text-thick button--text-upper button--size-s"><i className="fa-solid fa-spinner" /> Load More</a>
                    </div>
                </div>
            </section>
            ...
            <section className="recent-articles gap">
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                            <div className="blog-data">
                                <img alt="blog img" src={data.testimonials[0].image.url}
                                    style={{ width: '390px', height: '269px', objectFit: 'cover' }} />
                                <div className="message-icon"><i className="fa-solid fa-message" /><span>12</span></div>
                                <h6>December 5, 2023  <span>|</span> {data.testimonials[0].name}</h6>
                                <h4><a className="magic-hover magic-hover__square" href="#">{data.testimonials[0].position}</a></h4>
                                <p>{data.testimonials[0].review}</p>
                                <a className="magic-hover magic-hover__square" href="#"><i className="fa-solid fa-angle-right" /></a>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay={300} data-aos-duration={400}>
                            <div className="blog-data">
                                <img alt="blog img" src={data.testimonials[1].image.url}
                                    style={{ width: '390px', height: '269px', objectFit: 'cover' }} />
                                <div className="message-icon"><i className="fa-solid fa-message" /><span>22</span></div>
                                <h6>December 5, 2023  <span>|</span>   {data.testimonials[1].name}</h6>
                                <h4><a className="magic-hover magic-hover__square" href="#">{data.testimonials[1].position}</a></h4>
                                <p>{data.testimonials[1].review}</p>
                                <a className="magic-hover magic-hover__square" href="#"><i className="fa-solid fa-angle-right" /></a>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay={400} data-aos-duration={500}>
                            <div className="blog-data">
                                <img alt="blog img" src={data.testimonials[4].image.url}
                                    style={{ width: '390px', height: '269px', objectFit: 'cover' }} />
                                <div className="message-icon"><i className="fa-solid fa-message" /><span>12</span></div>
                                <h6>December 5, 2023  <span>|</span>   {data.testimonials[2].name}</h6>
                                <h4><a className="magic-hover magic-hover__square" href="#">{data.testimonials[3].position}</a></h4>
                                <p>{data.testimonials[2].review}</p>
                                <a className="magic-hover magic-hover__square" href="#"><i className="fa-solid fa-angle-right" /></a>
                            </div>
                        </div>
                        <div className="load-button" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                            <a href="#" className="magic-hover magic-hover__square button button--moema button--text-thick button--text-upper button--size-s">View All News</a>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-4 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                            <div className="e-mail">
                                <div className="icon-box"><i className="fa-solid fa-envelope" /></div>
                                <div><h6>Phone No</h6>
                                    <a className="magic-hover magic-hover__square" href="mailto:username@domain.com">{data.email}</a>
                                </div>
                            </div>
                            <div className="e-mail">
                                <div className="icon-box"><i className="fa-solid fa-phone" /></div>
                                <div><h6>Email Address</h6>
                                    <a className="magic-hover magic-hover__square" href="callto:+(123)4567890">{data.about.phoneNumber}</a>
                                </div>
                            </div>
                            <div className="e-mail">
                                <div className="icon-box"><i className="fa-solid fa-location-dot" /></div>
                                <div><h6>Location</h6>
                                    <a className="magic-hover magic-hover__square" href="">{data.about.address}</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-8 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay={300} data-aos-duration={400}>
                            <div className="your-name" style={{ backgroundImage: 'url(./img/blur-1.png)' }}>
                                <form className="one">
