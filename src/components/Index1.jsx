                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay={200} data-aos-duration={300}>
                            <div className="service-data">
                                ...
                                <h5><a className="magic-hover magic-hover__square" href="services-details.html">Immigration Application</a></h5>
                                <p>Lorem ipm dolor amet, consectetur
                                    magm maiores.Ipsa dolor sit ilmesy
                                    magnam maores.</p>
                            </div>
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay={300} data-aos-duration={400}>
                            <div className="service-data">
                                ...
                                <h5><a className="magic-hover magic-hover__square" href="services-details.html">Innovative Ideas</a></h5>
                                <p>Lorem ipm dolor amet, consectetur
                                    magm maiores.Ipsa dolor sit ilmesy
                                    magnam maores.</p>
                            </div>
                        ...
                        <div className="grid row align-items-center" data-aos="fade-up" data-aos-delay={400} data-aos-duration={500}>
                            ...
                            <div className="col-lg-4 Design Development">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img">
                                        <figure className="gap-img">
                                            <img className="one" alt="profile img" src="https://via.placeholder.com/250x250" />
                                            <div className="hover-data">
                                                <a className="magic-hover magic-hover__square" href="#">List of Brands</a>
                                                <p>Digital Web</p>
                                            </div>
                            ...
                            <div className="col-lg-4 UX/UI UI-Design Design">
                                <div className="portfolio-detail">
                                    <div className="portfolio-img">
                                        <figure className="gap-img">
                                            <img className="one" alt="profile img" src="https://via.placeholder.com/366x366" />
                                            <div className="hover-data">
                                                <a className="magic-hover magic-hover__square" href="#">List of Brands</a>
                                                <p>Digital Web</p>
                                            </div>
